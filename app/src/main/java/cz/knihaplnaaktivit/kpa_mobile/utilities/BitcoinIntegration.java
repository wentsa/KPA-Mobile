...
public final class BitcoinIntegration {
     ...
     * intent can be received by overriding {@link android.app.Activity#onActivityResult(int, int, Intent)}. Result indicates
     ...
     * @param requestCode
     *            Code identifying the call when {@link android.app.Activity#onActivityResult(int, int, Intent)} is called
     *            back
     * @param address
     *            Bitcoin address
     */
     ...
     * received by overriding {@link android.app.Activity#onActivityResult(int, int, Intent)}. Result indicates either
     ...
     * {@link android.app.Activity#onActivityResult(int, int, Intent)}. Result indicates either {@link Activity#RESULT_OK} or
